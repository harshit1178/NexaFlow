// Footer.tsx — Server Component (hovers handled by pure CSS in globals.css)
import { ChevronUpSolidIcon } from "@/app/components/Icons";
...
const socialLinks = [
  ...
  {
    /* link.svg — inline path (same content as Icons.tsx LinkIcon) so that
       the SVG path lives in a data array without triggering Next.js Server
       Component serialization errors for imported JSX element references. */
    label: "NexaFlow Documentation (external link)",
    href:  "#",
    icon: (
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Back to top — chevron-up-solid.svg */}
          <a
            href="#"
